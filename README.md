...
<ul>
                ...
                <li><strong>User Authentication:</strong> Implemented secure authentication using JWT (JSON Web Token).</li>
                <li><strong>Responsive Design:</strong> Ensured a seamless experience across desktop, tablet, and mobile devices.</li>
                <li><strong>Scalable Backend:</strong> Built a Node.js server with MongoDB for handling thousands of concurrent users.</li>
                <li><strong>Media Sharing:</strong> Enabled users to share images, videos, and documents within chats.</li>
</ul>
